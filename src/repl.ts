...
export class REPLProcess {
  ...
  public async start() {
    ...
    this.consoleCloseSubscription = window.onDidCloseTerminal((terminal) => {
      if (terminal === this.consoleTerminal) {
        this.log.appendLine(
          `${this.title} terminated or terminal UI was closed`
        );
